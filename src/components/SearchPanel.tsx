...
export function SearchPanel({
  ...
  return (
    <form
      action="/"
      className="grid gap-3 rounded-lg border border-ink/10 bg-white p-3 shadow-sm"
    >
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <label className="grid gap-1 text-xs font-semibold uppercase tracking-wide text-ink/45">
          ...
          <select
            className="min-h-11 rounded-md border border-ink/10 bg-paper px-3 text-sm font-medium normal-case tracking-normal text-ink outline-none transition focus:border-leaf focus:bg-white"
